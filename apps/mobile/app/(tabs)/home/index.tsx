...
function DashboardScreen() {
  ...
  // Same display rule as the read-only banner: on a narrow screen /home carries
  // the message, the top banner being reserved for wide web (see
  ...
  return (
    ...
    >
      ...
      <View className="px-4 -mt-5">
        ...
        {/* Unsaved changes; narrow screen and native only — wide web uses the
            top UnsavedChangesBanner */}
        {showUnsavedBanner && (
          <HomeBanner
