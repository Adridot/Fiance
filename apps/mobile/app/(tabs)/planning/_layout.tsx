...
export default function PlanningLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="speeches-music" options={{ title: t("music.title") }} />
      <Stack.Screen name="speech" options={{ title: t("speeches.newSpeech") }} />
      <Stack.Screen name="live" options={{ title: t("live.title") }} />
    </Stack>
  );
}
